/** \mainpage Driver Overview
  ...
  * - <b>Created</b>:          2015-10-23 17:59:33.337
  ...
  *     - <b>O: LED control pin 0</b>: DIO6
  *     - <b>O: LED control pin 1</b>: DIO7
  *
  *
...
/// ReedSwitch I/O mapping: LED control pin
#define SCIF_REED_SWITCH_DIO_OLED_CTRL { 6, 7 }
...
typedef struct {
    ...
    uint16_t pAuxioOLedCtrl[2];      ///< I/O mapping: LED control pin
...
typedef struct {
    struct {
        ...
        SCIF_REED_SWITCH_OUTPUT_T pOutput[2];
